...
import { Circle, Disc, ArrowRight } from "lucide-react";

interface OverdentureRelineImplantCheckProps {
    formConfig: UseFormReturn<CaseFormValues>;
    onSwitchToOverdenture: () => void;
}

export const OverdentureRelineImplantCheck = ({
    formConfig,
    ...
    return (
        <div className="bg-white p-6 md:p-8 space-y-6">
            <CommanHeading
                ...
                titleName="Will the reline be implant-supported?"
            />
            ...
            <div className="mt-8 flex gap-8 items-start">
                ...
                {/* Right side info box with Switch button */}
                <div className="flex-1 border rounded-xl p-6 bg-white hidden md:block">
                    <div className="flex flex-col items-center text-center space-y-4">
                        ...
                        <button
                            type="button"
                            onClick={onSwitchToOverdenture}
                            className="bg-gradient-to-r from-[#0B75C9] to-[#3BA6E5] text-white font-semibold px-6 py-3 rounded-lg flex items-center gap-2 hover:shadow-lg transition-shadow mt-2"
                        >
                            <span>Switch to Overdentures</span>
